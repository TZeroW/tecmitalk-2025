      ...
      <div className="max-w-2xl mx-auto bg-white/5 rounded-xl border border-tecmitalk-accent/30 p-6 md:p-8">
        ...
        <div className="bg-blue-900/10 border border-blue-400/20 rounded-lg p-6 mb-8">
          ...
          <div className="space-y-4 text-gray-300">
            ...
            <div className="flex justify-between">
              <span>Total:</span>
              <span className="text-white font-bold">${Number.parseFloat(amount).toFixed(2)}</span>
            </div>
        ...
        <div className="text-center text-gray-400 mb-8">
          <p className="mb-2">Hemos enviado los detalles de tu compra al correo electrónico proporcionado.</p>
          <p>
            Para cualquier duda,{" "}
            <a
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          ...
          <Link href={`/tickets/${orderId}`} className="flex-1">
            <Button className="w-full py-3 bg-tecmitalk-accent hover:bg-tecmitalk-accent/90">Ver Ticket</Button>
          </Link>
          <Link href="/" className="flex-1">
            <Button className="w-full py-3 bg-tecmitalk-accent hover:bg-tecmitalk-accent/90">Volver al inicio</Button>
          </Link>
        </div>
      </div>
    </div>
